...
ALTER TABLE E_PRESTAMOS 
  ADD COLUMN ESTATUS_DEVOLUCION BOOLEAN NOT NULL DEFAULT TRUE 
  AFTER ESTATUS;

ALTER TABLE E_PRESTAMOS 
  ADD COLUMN ID_REPORTE_VIDEOPROYECTOR INT(10) DEFAULT NULL 
  AFTER ESTATUS_DEVOLUCION;
...
ALTER TABLE E_PROFESORES RENAME COLUMN ESTATUS_ESCOLAR TO SIN_ADEUDO;

ALTER TABLE E_REP_VIDEOPROYECTORES 
  ADD COLUMN ID_PROFESOR VARCHAR(12) 
  AFTER ID_VIDEOPROYECTOR;
...
ALTER TABLE  E_USUARIOS ADD COLUMN DISPONIBLE BOOLEAN DEFAULT TRUE AFTER ADMINDR;

ALTER TABLE E_VIDEOPROYECTORES ADD COLUMN ACCESORIOS ARRAY AFTER NO_SERIE;